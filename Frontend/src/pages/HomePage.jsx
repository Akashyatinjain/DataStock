...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0F172A] font-['Inter'] selection:bg-blue-200 selection:text-blue-900 dark:selection:bg-[#3B82F6] dark:selection:text-[#F8FAFC] overflow-hidden transition-colors duration-200">
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 dark:bg-[#0F172A]/80 backdrop-blur-lg border-b border-gray-200 dark:border-[#334155] shadow-sm' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            {/* Logo */}
            <div className="flex items-center space-x-3 cursor-pointer group" onClick={() => window.scrollTo(0, 0)}>
              <div className="w-10 h-10 bg-black dark:bg-[#3B82F6] rounded-xl flex items-center justify-center transform group-hover:scale-105 transition-transform duration-300 shadow-md">
                <Cloud className="w-6 h-6 text-white" />
              </div>
              <span className="font-bold text-2xl tracking-tight text-gray-900 dark:text-[#F8FAFC]">DataStock</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#how-it-works" className="text-gray-600 dark:text-[#94A3B8] hover:text-[#3B82F6] font-medium transition-colors">How it works</a>
              ...
              <div className="flex items-center space-x-4 ml-4">
                ...
                <button
                  onClick={handleLogin}
                  className="px-5 py-2.5 text-gray-700 dark:text-[#94A3B8] font-semibold hover:text-[#3B82F6] transition-colors"
                >
                  Log in
                </button>
                <button
                  onClick={handleSignup}
                  className="px-6 py-2.5 rounded-xl bg-[#3B82F6] text-white font-semibold hover:bg-[#2563EB] transform hover:-translate-y-0.5 transition-all duration-200 shadow-lg shadow-[#3B82F6]/30"
                >
                  Get Started Free
                </button>
              </div>
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden absolute w-full bg-white dark:bg-[#0F172A] border-b border-gray-100 dark:border-[#334155] shadow-lg transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
          <div className="px-4 py-6 space-y-4 flex flex-col">
            ...
            <a href="#how-it-works" className="px-4 py-2 text-gray-600 dark:text-[#94A3B8] hover:bg-gray-50 dark:hover:bg-[#334155] rounded-lg font-medium" onClick={() => setIsMenuOpen(false)}>How it works</a>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#3B82F6]/20 rounded-full blur-3xl opacity-50"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mt-20 relative max-w-5xl mx-auto px-2 sm:px-0">
            ...
            <div className="absolute -inset-4 bg-linear-to-r from-[#3B82F6]/10 to-[#60A5FA]/15 rounded-3xl blur-2xl opacity-75 dark:opacity-50 pointer-events-none"></div>

            <div className="bg-white dark:bg-[#1E293B] rounded-t-3xl border border-gray-200/80 dark:border-[#334155] shadow-2xl overflow-hidden p-2 transform transition-transform hover:scale-[1.01] duration-500 relative z-10">
              {/* Browser Header Bar */}
              <div className="bg-gray-50 dark:bg-[#0F172A] px-4 py-3 flex items-center justify-between border-b border-gray-200/80 dark:border-[#334155]/80 rounded-t-2xl select-none">
                <div className="flex space-x-2 shrink-0">
                  <div className="w-3 h-3 rounded-full bg-red-400"></div>
                  <div className="w-3 h-3 rounded-full bg-yellow-400"></div>
                  <div className="w-3 h-3 rounded-full bg-green-400"></div>
                </div>
                <div className="bg-white dark:bg-[#1E293B] text-xs text-gray-400 dark:text-[#94A3B8] px-6 sm:px-16 py-1.5 rounded-lg border border-gray-200/60 dark:border-[#334155]/60 font-mono truncate max-w-xs sm:max-w-md w-full text-center">
                  datastock.com/dashboard
                </div>
                <div className="w-12"></div> {/* Spacer to keep URL centered */}
              </div>

              <div className="bg-gray-50 dark:bg-[#0F172A] p-4 sm:p-6 flex flex-col md:flex-row gap-6">
                {/* Mock Sidebar */}
                <div className="hidden md:block w-64 bg-white dark:bg-[#1E293B] rounded-xl p-4 border border-gray-100 dark:border-[#334155]/80 shadow-sm">
                  <div className="flex items-center space-x-2 mb-6">
                    <div className="w-8 h-8 bg-[#3B82F6]/10 rounded-lg flex items-center justify-center">
                      <Cloud className="w-5 h-5 text-[#3B82F6] dark:text-[#3B82F6]" />
                    </div>
                    <span className="font-bold text-gray-800 dark:text-[#F8FAFC]">My Storage</span>
                  </div>
                  <div className="space-y-1">
                    {['Recent', 'Starred', 'Shared', 'Trash'].map((item, i) => (
                      <div key={i} className={`px-3 py-2 rounded-lg text-sm font-medium transition ${i === 0 ? 'bg-blue-50 dark:bg-[#3B82F6]/10 text-[#3B82F6] dark:text-[#3B82F6]' : 'text-gray-600 dark:text-[#94A3B8] hover:bg-gray-50 dark:hover:bg-[#334155]/50'}`}>
                        {item}
                      </div>
                    ))}
                  </div>
                  <div className="mt-8">
                    <div className="flex justify-between text-xs mb-2">
                      <span className="text-gray-500 dark:text-[#94A3B8] font-medium">Storage Usage</span>
                      <span className="font-bold text-gray-700 dark:text-[#94A3B8]">
                    ...
                    <div className="w-full h-2 bg-gray-100 dark:bg-[#334155] rounded-full overflow-hidden">
                      <div className="h-full bg-[#3B82F6] rounded-full" style={{ width: `${storagePercentage}%` }}></div>
                    </div>
                  </div>
                </div>

                {/* Mock Main Area */}
                <div className="flex-1 bg-white dark:bg-[#1E293B] rounded-xl p-4 sm:p-6 border border-gray-100 dark:border-[#334155]/80 shadow-sm">
                  <div className="flex justify-between items-center mb-6">
                    <h3 className="text-lg font-bold text-gray-800 dark:text-[#F8FAFC]">Recent Files</h3>
                    <div className="flex gap-2">
                      <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-[#334155] flex items-center justify-center"><Menu className="w-4 h-4 text-gray-500 dark:text-[#94A3B8]" /></div>
                      <button
                        onClick={() => navigate(isLoggedIn ? '/dashboard' : '/login')}
                        className="bg-[#3B82F6] hover:bg-[#2563EB] text-white px-4 py-2 rounded-lg text-sm font-medium transition flex items-center space-x-2 shadow-sm"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {activeItems.map((file, i) => {
                      ...
                      return (
                        <div key={i} className="p-4 rounded-xl border border-gray-100 dark:border-[#334155]/80 hover:border-blue-200 dark:hover:border-[#3B82F6] hover:shadow-md transition-all cursor-pointer group bg-gray-50/50 dark:bg-[#0F172A]/30 hover:bg-white dark:hover:bg-[#1E293B]">
                          <div className="flex justify-between items-start mb-4">
                            <div className={`p-3 rounded-lg ${file.bg}`}>
                              <Icon className={`w-6 h-6 ${file.color}`} />
                            </div>
                            <button className="text-gray-400 dark:text-[#94A3B8] opacity-0 group-hover:opacity-100 transition-opacity"><Menu className="w-4 h-4" /></button>
                          </div>
                          <h4 className="font-semibold text-gray-800 dark:text-[#F8FAFC] text-sm mb-1 truncate">{file.name}</h4>
                          <p className="text-xs text-gray-500 dark:text-[#94A3B8]">{file.size} • Active</p>
                        </div>
                      );
                    })}
                  </div>
      ...
      {/* Social Proof */}
      <section className="py-10 border-t border-b border-gray-200 dark:border-[#334155] bg-white dark:bg-[#1E293B] transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm font-semibold text-gray-500 dark:text-[#94A3B8] uppercase tracking-wider mb-6">Trusted by innovative teams worldwide</p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 dark:opacity-50 grayscale hover:grayscale-0 dark:hover:opacity-80 transition-all duration-500">
            {/* Fake logos using text for layout */}
            <div className="text-2xl font-bold font-serif text-gray-800 dark:text-[#94A3B8]">Acme Corp</div>
            <div className="text-2xl font-extrabold italic text-gray-800 dark:text-[#94A3B8]">GlobalTech</div>
            <div className="text-2xl font-medium tracking-widest text-gray-800 dark:text-[#94A3B8]">NEXUS</div>
            <div className="text-2xl font-black lowercase text-gray-800 dark:text-[#94A3B8]">horizon</div>
            <div className="text-2xl font-bold text-gray-800 dark:text-[#94A3B8] flex items-center"><Cloud className="w-6 h-6 mr-1 text-green-500" /> Vertex</div>
          </div>
        </div>
      </section>

      {/* Explanation / What is it? */}
      <section id="how-it-works" className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-[#0F172A]/40 border-b border-gray-100 dark:border-[#334155] transition-colors">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-sm font-bold text-[#3B82F6] dark:text-[#3B82F6] tracking-wide uppercase mb-3">Why DataStock?</h2>
                  ...
                  <div key={i} className="flex space-x-4">
                    <div className="shrink-0 mt-1">
                      <div className="w-10 h-10 rounded-lg bg-blue-100 dark:bg-[#3B82F6]/10 flex items-center justify-center">
                        <item.icon className="w-5 h-5 text-[#3B82F6] dark:text-[#3B82F6]" />
                      </div>
                    </div>
                    <div>
                      <h4 className="text-xl font-bold text-gray-900 dark:text-[#F8FAFC] mb-1">{item.title}</h4>
                      <p className="text-gray-600 dark:text-[#94A3B8] leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="relative">
              ...
              {/* Floating card */}
              <div className="absolute -bottom-6 -left-6 bg-white dark:bg-[#1E293B] p-6 rounded-2xl shadow-xl z-20 border border-gray-100 dark:border-[#334155] animate-bounce" style={{ animationDuration: '3s' }}>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-blue-100 dark:bg-[#3B82F6]/10 rounded-full flex items-center justify-center">
                    <CheckCircle2 className="w-6 h-6 text-[#3B82F6] dark:text-[#3B82F6]" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-[#94A3B8] font-medium">Backup Complete</p>
                    <p className="text-lg font-bold text-gray-900 dark:text-[#F8FAFC]">1,240 files synced</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Features Grid */}
      <section id="features" className="py-24 bg-white dark:bg-[#0F172A] px-4 sm:px-6 lg:px-8 relative border-b border-gray-100 dark:border-[#334155]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
            {[
              ...
              <div key={i} className="group cursor-pointer">
                <div className="w-14 h-14 bg-gray-50 dark:bg-[#1E293B] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#2563EB] transition-colors duration-300 shadow-sm border border-gray-100 dark:border-[#334155]">
                  <feature.icon className="w-7 h-7 text-gray-700 dark:text-[#94A3B8] group-hover:text-white transition-colors duration-300" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-[#F8FAFC] mb-3 group-hover:text-[#3B82F6] dark:group-hover:text-[#3B82F6] transition-colors">{feature.title}</h3>
                <p className="text-gray-600 dark:text-[#94A3B8] leading-relaxed text-lg">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
                ...
                <div key={i} className={`relative bg-slate-800 dark:bg-[#1E293B] rounded-3xl p-8 border hover:scale-[1.02] transition-transform duration-300 ${isCurrentPlan
                  ...
                  {plan.popular && !isCurrentPlan && (
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                      <span className="bg-[#3B82F6] text-white text-sm font-bold px-4 py-1.5 rounded-full uppercase tracking-wider shadow-lg">
                        Most Popular
                      </span>
                    </div>
                  )}
                  ...
                  <div className="bg-slate-900/50 dark:bg-[#0F172A]/50 rounded-xl p-4 mb-8 border border-slate-700/50 dark:border-[#334155]/50">
                    <span className="text-[#3B82F6] dark:text-[#3B82F6] font-bold text-xl">{plan.storage}</span>
      ...
      <section className="py-24 bg-white dark:bg-[#1E293B] relative overflow-hidden transition-colors">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex justify-center">
            <button
              onClick={handleSignup}
              className="px-10 py-5 bg-black dark:bg-[#3B82F6] text-white dark:text-[#F8FAFC] rounded-2xl font-bold text-xl hover:bg-[#2563EB] dark:hover:bg-[#2563EB] transform hover:scale-105 transition-all duration-300 shadow-2xl flex items-center space-x-3 group"
            >
      ...
      <footer className="bg-gray-50 dark:bg-[#0F172A] pt-20 pb-10 px-4 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-[#334155] transition-colors">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
            <div className="col-span-2 lg:col-span-2">
              <div className="flex items-center space-x-2 mb-6">
                <div className="w-8 h-8 bg-black dark:bg-[#3B82F6] rounded-lg flex items-center justify-center">
                  <Cloud className="w-5 h-5 text-white dark:text-[#F8FAFC]" />
                </div>
                <span className="font-bold text-xl text-gray-900 dark:text-[#F8FAFC]">DataStock</span>
              </div>
              <p className="text-gray-500 dark:text-[#94A3B8] mb-6 max-w-xs leading-relaxed">
                The most secure, beautiful, and intelligent home for all your files. Built for the modern digital life.
              </p>
              <div className="flex space-x-4">
                {/* Social placeholders */}
                <div className="w-10 h-10 rounded-full bg-gray-200 dark:bg-[#334155] hover:bg-blue-100 dark:hover:bg-[#3B82F6]/10 flex items-center justify-center transition-colors cursor-pointer text-gray-500 dark:text-[#94A3B8] hover:text-[#3B82F6] dark:hover:text-[#3B82F6]">
            ...
            <div>
              <h4 className="font-bold text-gray-900 dark:text-[#F8FAFC] mb-5 uppercase text-sm tracking-wider">Product</h4>
              <ul className="space-y-3">
                {['Features', 'Download', 'Security', 'Pricing', 'Releases'].map((link) => (
                  <li key={link}>
                    <a href="#" className="text-gray-500 dark:text-[#94A3B8] hover:text-[#3B82F6] dark:hover:text-[#3B82F6] font-medium transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
            ...
            <div>
              <h4 className="font-bold text-gray-900 dark:text-[#F8FAFC] mb-5 uppercase text-sm tracking-wider">Company</h4>
              <ul className="space-y-3">
            ...
            <div>
              <h4 className="font-bold text-gray-900 dark:text-[#F8FAFC] mb-5 uppercase text-sm tracking-wider">Legal</h4>
              <ul className="space-y-3">
          ...
          <div className="border-t border-gray-200 dark:border-[#334155] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 dark:text-[#94A3B8] font-medium text-sm">© {new Date().getFullYear()} DataStock Inc. All rights reserved.</p>
            <div className="flex items-center space-x-2 text-sm font-medium text-gray-500 dark:text-[#94A3B8]">
              <span>Made with</span>
